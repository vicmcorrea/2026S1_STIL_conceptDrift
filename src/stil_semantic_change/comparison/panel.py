...
def build_comparison_panel(
    ...
    selected_terms = word2vec_drift | tfidf_drift | word2vec_stable | tfidf_stable | theory_seeds
    ...
    merged["selected_as_stable_control"] = (
        merged["selected_as_stable_control_word2vec"] | merged["selected_as_stable_control_tfidf"]
    )
